...
article-published-date: "10/20/2023 8:14:30 PM"
version-number: 4
...
`12105:org.apache.jackrabbit.oak "SessionStatistics" "admin@session-12105@Aug 10, 2020 7:03:25 PM" {id=287}`.3. The higher the id number, the later the session was created after the last AEM restart.
4. XReview the stack traces showing which code opened those sessions.
5. XSearch for application java packages in the stack.  If the code is part of your application, then see the next section below.
