...
A customer experienced continuous failures while publishing multiple assets, especially images. Oftentimes, their images got stuck on a never ending status "Later" while at other times, they were stuck on the state "Pending", failing into "Not Published".
