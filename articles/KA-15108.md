...
Once the necessary permission is taken using consent form, you would need to send the choices to Opt-in Service. For steps refer, to [Setting up Opt-in Service](https://experienceleague.adobe.com/docs/id-service/using/implementation/opt-in-service/getting-started.html). 
