...
description: Learn how to solve the "Bad Request" error when opening a page in AEM.
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: Experience Manager as a Cloud Service,Experience Manager
keywords: KCS, size, request header, exceed, server limit, AEM, Adobe Experience Manager, Troubleshooting, AEMaaCS, Adobe Experience Manager as a Cloud Service
...
Increase the value for `#LimitRequestFieldSize` and `#LimitRequestLine` for AMS/On-Premises versions. Increase the <b>Request Header</b> limit by also adding those properties in the Vhost files for AEMaaCS.
...
When opening a page, users receive a "<b>Bad Request</b>" response with the message:
...
Apache has a default `LimitRequestLine` of *8K*. For more information, consult [Apache's Core Features: LimitRequestLine Directive](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) on the Apache website.
