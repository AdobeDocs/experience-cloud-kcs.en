...
11. Mongo storage tuning
    ...
    - <b>Implement the MongoDB production checklist:</b>        
        [https://docs.mongodb.org/manual/administration/production-checklist/](http://docs.mongodb.org/manual/administration/production-checklist/) - according to Mongo DB support, many of the items have a large impact on performance. For any questions, contact MongoDB Support directly.
