...
article-published-date: "5/27/2024 5:15:27 PM"
version-number: 4
...
This document will give guidance on how flushing occurs and explains the mechanism that executes cache flushing and invalidation.
<br><br>How it works<br>
### <b>Order of Operation</b>

The typical workflow is best described when content authors will activate a page, when publisher receives the new content it triggers a flush request to the dispatcher as shown in the following diagram:![](assets/___c36d65be-9217-ef11-9f8a-6045bd006793___.png)
