---
title: Pipeline failing with error "The end_aem_createsegmentstore property is missing"
...
exl-id: e853e072-8916-42bb-bd1d-1162b2b39179
---
# Pipeline failing with error "The end_aem_createsegmentstore property is missing"

## Description {#description}

The CI/CD pipeline keeps failing during the "Deploy to Dev" stage. <br><br>The deploy logs did not show any error due to the code base but the following errors are present:<br><br> <br><br> <br><br> <br><br>`[` 1`]`   
...
In the logs, the errors `[` 1`]`  are present during the deployment timeframe. Most likely the node - `[` 2`]`  is not present on the publisher and/or preview server and the replication fails.
