...
article-published-date: "6/18/2024 9:16:13 PM"
version-number: 4
...
4. The new credential <b>OAuth Server-to-Server</b> has been added to the left side.
    ...
    - 
        ...
        Click the <b>Review and Delete </b>button after verifying if the new credential <b>OAuth Server-to-Server</b> is working correctly. And delete the JWT credential to complete the migration.
...
5. Update the user application code with OAuth2.0 library to generate access token with the new credential.
