...
article-published-date: "5/31/2023 6:03:18 AM"
version-number: 1
...
1. Log in to the Adobe Developer Console ([https://developer.adobe.com/console](https://developer.adobe.com/console)) .
 
2. From the filtering menu on the left side, select the option 'Has Service Account (JWT) credential'.
...
3. Click the "Add new credential" button to start migration

![](assets/0b40853d-faf5-ed11-8848-6045bd006704.png)

4. The new credential 'OAuth Server-to-Server' has been added to the left side.
