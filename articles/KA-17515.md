...
article-published-date: "4/12/2024 8:01:29 PM"
version-number: 6
...
<u>Scenario 1: Moderate-Size Deployment</u>

![scenario-1](https://experienceleague.adobe.com/docs/campaign-classic/assets/scenario-1.png?lang=en)

<u>Estimated volume</u>
...
<b>*Caution - </b><b>This estimate does not include any additional customer data. If you are planning to replicate additional columns or tables of customer data into the Adobe Campaign database, then you have to estimate the additional disk space requirement for it. Uploaded segments/lists also require more storage, depending on their size, frequency, and retention period.*
...
<u>Scenario 2: Large-Size Deployment</u>

![scenario-2](https://experienceleague.adobe.com/docs/campaign-classic/assets/scenario-2.png?lang=en)
...
Refer to [Scenario 1: Moderate-Size Deployment](https://experienceleague.adobe.com/docs/campaign-classic/using/technotes/hardware-sizing.html?lang=en#scenario-1) for more comments on proxies, preference centers/subscription handling, and disk space usage.
...
<u>Scenario 3: Enterprise Deployment with Message Center</u>

![scenario-3](https://experienceleague.adobe.com/docs/campaign-classic/assets/scenario-3.png?lang=en)
...
The deployment supporting 50 million recipients is essentially the same as shown in [Scenario 2](https://experienceleague.adobe.com/docs/campaign-classic/using/technotes/hardware-sizing.html?lang=en#scenario-2). Campaign web application traffic is routed to Campaign web servers, so the bursts of web traffic after large campaign launches does not impact Campaign workflows and Client Console users.
...
</b>Guidelines for Changing Assumptions<b>
