...
The list of supported search engines in Adobe Analytics is dynamic and can change with the updated list.
 However, as of February 2022, here is the list of supported search engines in Adobe Analytics.
