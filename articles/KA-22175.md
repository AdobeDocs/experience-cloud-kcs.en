...
description: "Learn how to solve the issue where an attempt to Single Sign-On (SSO) results in a user not mapped error."
solution: Workfront
product: Workfront
...
article-created-date: "4/30/2024 8:22:17 PM"
article-published-by: Victoria Barnato
article-published-date: "4/30/2024 8:28:28 PM"
version-number: 2
article-number: KA-22175
dynamics-url: "https://adobe-ent.crm.dynamics.com/main.aspx?forceUCI=1&pagetype=entityrecord&etn=knowledgearticle&id=49ea5a55-2f07-ef11-9f8a-6045bd0a08d9"

---
# Login Error as user not Mapped SSO (Single Sign On)


To solve the login error ensure that the user has a Federation ID listed in their Workfront account and use the audit logs as a troubleshooting tool.
