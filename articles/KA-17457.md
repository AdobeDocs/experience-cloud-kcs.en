...
article-published-date: "4/3/2023 7:49:56 PM"
version-number: 7
...
5. Review caching strategies implemented at the AEM dispatcher level.
...
Once you've captured a Heap Dump file then open it in [Eclipse MAT](http://www.eclipse.org/mat/) or [IBM Memory Analyzer](https://developer.ibm.com/languages/java/) tool.  In Eclipse MAT, run the Leak Suspects report and open "Thread Details" view to see potential causes for the memory issue.
...
2. Review the replication configurations if your server is cloned or the agent has been configured recently. For details, see [here](experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/replication.html?lang=en#configuring-your-replication-agents-from-the-author-environment).
