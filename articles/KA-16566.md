...
description: "Learn how to optimize Oak Lucene indexes to reduce indexing time."
...
Optimize the Oak Lucene indexes using includedPaths and excludedPaths properties.
