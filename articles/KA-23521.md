...
description: Learn how to resolve issues with the move page feature, causing failure in deletion or publication due to issues with fetching content fragment references.
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager 6.5
keywords: KCS, Move Page Feature, Deletion, Reference retrieval issues, AMS customer, CSE assistance, Reindex, Content Fragment, Publication
...
Explore how to address the malfunctioning of the move page feature that hinders actions like deletion or publication due to content fragment reference retrieval issues.
...
When trying to move, delete, or publish either Content Fragments, Sites, or Pages, an issue occurs when Content Fragment references are fetched, preventing the action.
