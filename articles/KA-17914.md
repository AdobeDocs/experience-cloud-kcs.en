...
description: "Learn how to deal with common log entries in Adobe Experience Manager."
...
For more details, follow the [Adobe Managed Services Dispatcher manual](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17490.html) in the AEM Tutorials guide.
...
This means your fetching from render level vs. from cache is measured. You want to hit 80+ percent from the cache, and you should follow the help [here](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17458.html):
