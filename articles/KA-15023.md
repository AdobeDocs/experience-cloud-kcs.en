...
1. Select “Core” from Extension drop down.
2. Select “Custom Code” from Action Type drop down.
3. t-size:12.0pt"`>` Add Action name in Name text box.
4. Select “Javascript” under Language.
5. Check “Execute globally”.
6. Click “Open Editor”.
...
2. Select “Custom Code” from Action Type drop down.
3. Add Action name in Name text box.
4. font-size:12.0pt"`>` Select “Javascript” under Language.
5. pan style="font-size:12.0pt"`>` Check “Execute globally”.
6. style="font-size:12.0pt"`>` Click “Open Editor”.
7. span style="font-size:12.0pt"`>` Add Visitor ID Service code.
